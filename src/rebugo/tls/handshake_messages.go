...
//Rebujacker -- Changes in how the TLS HELLO is crafted
func (m *clientHelloMsg) marshal() []byte {
	...
	b.AddUint24LengthPrefixed(func(b *cryptobyte.Builder) {
		...
		//tlsExtensions
		if (m.tlsExtensions[0] != "None"){

			//13172, "NOT RFC Assigned"
			if m.nextProtoNeg {
			...
			for _,tls3 := range m.tlsExtensions{
				...
				switch tls3{
					...
					case "13":
						...
						//Same sig_algth that Chrome v78
							...
							b.AddUint16LengthPrefixed(func(b *cryptobyte.Builder) {
								b.AddUint16LengthPrefixed(func(b *cryptobyte.Builder) {
									//for _, sigAlgo := range m.supportedSignatureAlgorithms {
										b.AddUint16(uint16(0x0403))
										b.AddUint16(uint16(0x0804))
										b.AddUint16(uint16(0x0401))
										b.AddUint16(uint16(0x0503))
										b.AddUint16(uint16(0x0805))
										b.AddUint16(uint16(0x0501))
										b.AddUint16(uint16(0x0806))
										b.AddUint16(uint16(0x0601))
										b.AddUint16(uint16(0x0201))
									//}
								})
							})
						//}
					...
					case "43":
						if len(m.supportedVersions) > 0 {
							...
							b.AddUint16LengthPrefixed(func(b *cryptobyte.Builder) {
								b.AddUint8LengthPrefixed(func(b *cryptobyte.Builder) {
									//Adding "Uknown" to comply with chrome details
									b.AddUint16(0x4a4a)
